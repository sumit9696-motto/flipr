            ...
            while($item_row = mysqli_fetch_array($item_run))
{
 ?>
                <tr>
                    ...
                    <td><a class="btn btn-dark" href="updateitem.php?id=<?php  echo $item_row['id']; ?>">Edit</a></td>
                    <!-- <button ><a href=".html" style="text-decoration: none;"class= "text-light";>Edit</a></button> -->
                    
                    <form action ="iteam.php"; method="post":>
...
if(isset($_POST['delete_btn'])){
  ...
  $delete_query="DELETE FROM item WHERE id ='$delete'";
  $delete_query_run=mysqli_query($conn,$delete_query);
  if($delete_query_run){
    echo"<script>alert('Iteam Delete successfuly ....');window.location.href='iteam.php'</script>";
  }
  else{
